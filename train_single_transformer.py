...
from FIA_dataset.FIA_dataset_CNNLSTM_transformer import FIA_dataset
from model_single_transformer import MARS, CNN_LSTM, Transformer
...
class Trainer():
    ...
    def train(self):
        ...
        #! test other model
        model = Transformer(src_vocab_size=self.batch_size*5*8*8, tgt_vocab_size=96, d_model=96, num_heads=6, num_layers=3, d_ff=512, max_seq_length=2048, dropout=self.dropout, device=self.device).to(self.device)
